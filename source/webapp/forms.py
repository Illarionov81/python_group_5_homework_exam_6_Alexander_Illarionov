...
class GuestBookForm(forms.Form):
    name = forms.CharField(max_length=100, required=True, empty_value="Автор", initial="Автор", label='Имя Автора: ')
    email = forms.EmailField(max_length=100, required=True, empty_value="Емайл", initial="Емайл", label='Емайл: ')
